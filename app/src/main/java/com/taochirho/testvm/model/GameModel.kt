...
import com.taochirho.testvm.ui.main.GameFragmentArgs
...
class GameModel(application: TestVMApplication) : AndroidViewModel(application),
...
*/
    ...
    private var forChecking: String = ""

    private val _gameTag: MutableLiveData<String> = MutableLiveData("Fooey")
    var gameTag: LiveData<String> = _gameTag

    private val _gameCreator: MutableLiveData<String> = MutableLiveData("Piltdown")
    ...
    private var _duration: MutableLiveData<Int> = MutableLiveData(15) // in minutes
    var duration: LiveData<Int> = _duration
...
//        Log.w(TAG, "pauseTimer()")
  ...
  */
    ...
    fun restoreCurrentGame() {
        viewModelScope.launch {
            val cg = dataRepository.getCurrent()
            ...
            if (cg == null) {
                ...
                dataRepository.insertCurrent(currentGame)
