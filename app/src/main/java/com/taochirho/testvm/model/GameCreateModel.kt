...
import com.taochirho.testvm.application.*
import com.taochirho.testvm.database.*
...
class GameCreateModel(application: TestVMApplication) : AndroidViewModel(application) {
    ...
    /* private val initialLetters = CharArray(49){ '\u0020' }  // \u0020 is unicode space
     ...
     val letters = Array<LiveData<Char>>(uiState.rows * uiState.cols) { i -> _letters[i] }*/
    ...
    val enteredLetter11: LiveData<Char> = _enteredLetter11
    ...
    val enteredLetter17: LiveData<Char> = _enteredLetter17
