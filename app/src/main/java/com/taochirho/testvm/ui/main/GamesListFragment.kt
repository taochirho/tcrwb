...
import com.taochirho.testvm.databinding.GamesListFragmentBinding
import com.taochirho.testvm.model.GamesListModel
import com.taochirho.testvm.model.GamesListModelFactory
...
class GamesListFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        val application = requireNotNull(this.activity).application as TestVMApplication

        gamesListVM = ViewModelProvider(
            this,
            GamesListModelFactory(application)
        ).get(GamesListModel::class.java)
        ...
        if (resources.configuration.orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            context?.let {
                ContextCompat.getDrawable(it, R.drawable.line_divider_landscapet)
